...
public class ComercioTest {
  ...
  public void comercio() {
    driver.get("http://localhost:8080/BC-WEBAPP/FormLoginServlet?email=latienda%40email.com&password=123&remember=on");
    driver.manage().window().setSize(new Dimension(1294, 694));
    driver.findElement(By.cssSelector("form:nth-child(2) > .boton")).click();
    driver.findElement(By.id("nombre")).click();
    driver.findElement(By.id("nombre")).sendKeys("Galletas");
    driver.findElement(By.id("precio")).click();
    driver.findElement(By.id("precio")).sendKeys("2.00");
    ...
    driver.findElement(By.cssSelector("form:nth-child(5) > .boton")).click();
  }
}
